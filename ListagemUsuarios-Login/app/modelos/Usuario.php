...
class Usuario {
    ...
    */
    ...
    /**
     * Função estática, pois não depende do estado de uma instância,
     * para listar todos os usuários cadastrados no sistema.
     * 
     * @return Usuario[] retorna um vetor de instâncias de usuário.
     */
    ...
    public static function listarUsuarios(){
        ...
        foreach($resultados as $resultado){
            if($resultado['email'] != 'suporte@login.com'){
                $usuario = self::buscar($resultado['email']);
